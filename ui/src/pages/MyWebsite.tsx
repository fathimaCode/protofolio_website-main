...
const MyWebsite: React.FC = () => {
  ...
  return (
    <div className="pro_body">
      ...
      <PROHEADER logoName={logo} bgColor={bgcolor} gender={gender} linkendin={link} insta={insta} userid={id || ''}  toggleContact={toggleContact} />
      ...
      {showContact && <Contact email={email} location={location} bgcolor={bgcolor} contact={contact}/>}
